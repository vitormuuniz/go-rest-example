...
type PaginationBuilderRepository interface {
	BuildProductsMetada(*http.Request) (*Metadata, error)
}
...
func (p *paginationBuilderRepositoryImpl) BuildPages(elements int64, limit int) int {
	var pages int
	total := int(elements)
...
func (p *paginationBuilderRepositoryImpl) BuildProductsMetada(r *http.Request) (*Metadata, error) {
